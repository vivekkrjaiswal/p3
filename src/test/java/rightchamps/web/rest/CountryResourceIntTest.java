...
import rightchamps.domain.Country;
import rightchamps.repository.CountryRepository;
import rightchamps.service.CountryService;
...
public class CountryResourceIntTest {
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getDateTime()).isEqualTo(DEFAULT_DATE_TIME);
    }
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getDateTime()).isEqualTo(UPDATED_DATE_TIME);
    }
