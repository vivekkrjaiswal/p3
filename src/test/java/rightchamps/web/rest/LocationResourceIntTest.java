...
import rightchamps.P3App;

import rightchamps.domain.Location;
import rightchamps.repository.LocationRepository;
import rightchamps.service.LocationService;
...
@SpringBootTest(classes = P3App.class)
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getDateTime()).isEqualTo(DEFAULT_DATE_TIME);
    }
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getDateTime()).isEqualTo(UPDATED_DATE_TIME);
    }
