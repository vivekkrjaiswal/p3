...
import rightchamps.domain.Region;
import rightchamps.repository.RegionRepository;
import rightchamps.service.RegionService;
...
public class RegionResourceIntTest {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getDateTime()).isEqualTo(DEFAULT_DATE_TIME);
    }
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getDateTime()).isEqualTo(UPDATED_DATE_TIME);
    }
