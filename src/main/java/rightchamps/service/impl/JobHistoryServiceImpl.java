package rightchamps.service.impl;

import rightchamps.service.JobHistoryService;
import rightchamps.domain.JobHistory;
import rightchamps.repository.JobHistoryRepository;
...
public class JobHistoryServiceImpl implements JobHistoryService {
    ...
    public JobHistory save(JobHistory jobHistory) {
        log.debug("Request to save JobHistory : {}", jobHistory);        return jobHistoryRepository.save(jobHistory);
    }
